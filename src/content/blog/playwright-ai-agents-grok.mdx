...
> _"Generate a prompt for Claude Code to demonstrate Playwright's AI code generation and test case healing features by creating a test application and also set up the Playwright Test Agents (planner, generator and healer) to test the application."_
